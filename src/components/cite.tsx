  ...
  return (
    <span className="relative inline">
      ...
      {visible && (
        <span
          role="tooltip"
          className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 z-50 w-64 bg-white border border-[#E2E8F0] rounded-lg shadow-lg p-3 text-left pointer-events-none"
        >
